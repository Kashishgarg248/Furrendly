...
shadow-xl backdrop-blur-md"
        >
          ...
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <span className="inline-block bg-green-600/90 backdrop-blur-sm text-white px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-medium mb-4 shadow-md">
              Future Services
            </span>
...
whitespace-nowrap flex-shrink-0 text-sm sm:text-base"
          ...
          <motion.p
            ...
            className="text-center text-xs sm:text-sm text-gray-600 mt-8 sm:mt-10"
          >
            💡 Notify Me on Launch
          </motion.p>
        </motion.div>
